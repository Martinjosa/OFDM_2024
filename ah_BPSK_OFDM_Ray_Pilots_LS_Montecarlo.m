...
%         CON CANAL ESTATICO Y ECUALIZACION LEAST SQUARE (LS)             %        
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for k=1:20
    for i=1:length(SNR)
       ...
       % Simular el canal de Rayleigh
        ...
        % Estimación del canal usando los pilotos
        H_est = pulsos_demodulados_ofdm(indices_pilotos, :) ./ secuencias_piloto; % Estimación del canal en los índices de los pilotos

        % Interpolación lineal para obtener la estimación del canal completa
        H_interpolado = interp1(indices_pilotos, H_est, 1:num_subportadoras, 'linear', 'extrap');
